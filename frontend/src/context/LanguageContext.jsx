...
export const translations = {
  en: {
    ...
    about_intro_heading: "Built for the space between",
    ...
    about_intro_p2: "Whether it's a pothole on the school run or a transformer that has been sparking for a week, every report follows the same path: submitted, located, reviewed, and handed to the office responsible for fixing it.",
    about_features_heading: "A structured way to report and respond.",
    ...
    about_mission_p: "Most civic complaints disappear into inboxes and phone logs with no way to follow up later. CivicPulse AI gives every report a case number, a location and a status, so citizens can see what happened to what they filed, and departments have a record of how they responded.",
  ...
  si: {
    ...
    about_intro_heading: "පුරවැසියා සහ නගර සභාව",
    about_intro_heading_2: " අතර අවකාශය සඳහා නිර්මාණය කර ඇත.",
    ...
    about_features_heading: "වාර්තා කිරීමට සහ ප්‍රතිචාර දීමට ව්‍යුහගත ආකාරය.",
    ...
    about_categories_title: "මිනිසුන්ට ලොකු මුදලක් නොව, සෑම ගැටළුවක් සඳහාම එක් පෝරමයක්.",
    ...
    about_mission_p: "බොහෝ සිවිල් පැමිණිලි ඊමේල් හා දුරකථන ලොගවල අතුරුදහන් විය හැකි අතර පසුව අනුගමනය කළ නොහැක. CivicPulse AI සෑම වාර්තාවක්ම නඩු අංකයක්, ස්ථානයක් සහ තත්ත්වයක් ලබා දේ, එමඟින් පුරවැසියන්ට තම වාර්තාව කුමක් කළේදැයි දැනගැනීමට සහ දෙපාර්තමේන්තුවට ප්‍රතිචාරය ලේඛනගත කිරීමට හැකියාව ලැබේ.",
